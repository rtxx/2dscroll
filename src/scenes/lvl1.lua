...
function scene:load()
  ...
  gameMap               = Map:new(maps.lvl1.map, world)
  ...
  gameVars.currentPlayerCamera  = camera(gameVars.gameSizeW/2,gameVars.gameSizeH/2, gameVars.gameSizeW,gameVars.gameSizeH)
  ...
  musicBackground     = love.audio.newSource(maps.lvl1.sounds.music, "stream")
...
function scene:draw()
  ...
  love.graphics.print("lvl1", gameVars.windowSizeW-100, 10)
